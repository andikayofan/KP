...
<head>
  ...
  <title>Monitoring Peripheral</title>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="adminlte/dist/cssadminlte.min.css ">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="adminlte/dist/imgadminlteLogo.png " alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">adminlte</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">adminlte v1</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!-- AdminLTE App -->
<script src="adminlte/dist/jsadminlte.js "></script>
<!-- AdminLTE adminlte demo (This is only for demo purposes) -->
<script src="adminlte/dist/js/pagesadminlte.js "></script>
